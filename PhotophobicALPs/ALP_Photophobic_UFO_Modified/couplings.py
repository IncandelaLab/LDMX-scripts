...
GC_20 = Coupling(name = 'GC_20',
                 value = '-((cw*ee**3*complex(0,1))/(Lambda*sw**3))',
                 order = {'QED':3})
...
GC_24 = Coupling(name = 'GC_24',
                 value = '(ee**2*complex(0,1))/(2.*Lambda*sw**2)',
                 order = {'QED':2})

GC_25 = Coupling(name = 'GC_25',
                 value = '-((ee**3*complex(0,1))/(Lambda*sw**2))',
                 order = {'QED':3})
...
GC_48 = Coupling(name = 'GC_48',
                 value = '(cw**2*ee**2*complex(0,1))/(2.*Lambda*sw**2) - (ee**2*complex(0,1)*sw**2)/(2.*cw**2*Lambda)',
                 order = {'QED':2})
...
GC_45 = Coupling(name = 'GC_45',
                 value = '(cw*ee**2*complex(0,1))/(2.*Lambda*sw) + (ee**2*complex(0,1)*sw)/(2.*cw*Lambda)',
                 order = {'QED':2})
