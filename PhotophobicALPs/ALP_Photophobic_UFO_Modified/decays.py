...
# Mathematica version: 11.0.0 for Microsoft Windows (64-bit) (July 28, 2016)
# Date: Wed 3 May 2017 13:48:59
...
Decay_p1 = Decay(name = 'Decay_p1',
                 particle = P.p1,
                 partial_widths = {(P.a,P.Z):'((MP**2 - MZ**2)*((ee**4*MP**4)/Lambda**2 - (2*ee**4*MP**2*MZ**2)/Lambda**2 + (ee**4*MZ**4)/Lambda**2 + (cw**2*ee**4*MP**4)/(2.*Lambda**2*sw**2) - (cw**2*ee**4*MP**2*MZ**2)/(Lambda**2*sw**2) + (cw**2*ee**4*MZ**4)/(2.*Lambda**2*sw**2) + (ee**4*MP**4*sw**2)/(2.*cw**2*Lambda**2) - (ee**4*MP**2*MZ**2*sw**2)/(cw**2*Lambda**2) + (ee**4*MZ**4*sw**2)/(2.*cw**2*Lambda**2)))/(16.*cmath.pi*abs(MP)**3)',
                                   (P.W__minus__,P.W__plus__):'(((ee**4*MP**4)/(2.*Lambda**2*sw**4) - (2*ee**4*MP**2*MW**2)/(Lambda**2*sw**4))*cmath.sqrt(MP**4 - 4*MP**2*MW**2))/(16.*cmath.pi*abs(MP)**3)',
                                   (P.Z,P.Z):'((-((ee**4*MP**4)/Lambda**2) + (4*ee**4*MP**2*MZ**2)/Lambda**2 + (cw**4*ee**4*MP**4)/(2.*Lambda**2*sw**4) - (2*cw**4*ee**4*MP**2*MZ**2)/(Lambda**2*sw**4) + (ee**4*MP**4*sw**4)/(2.*cw**4*Lambda**2) - (2*ee**4*MP**2*MZ**2*sw**4)/(cw**4*Lambda**2))*cmath.sqrt(MP**4 - 4*MP**2*MZ**2))/(32.*cmath.pi*abs(MP)**3)'})
...
Decay_Z = Decay(name = 'Decay_Z',
                particle = P.Z,
                partial_widths = {(P.a,P.p1):'((-MP**2 + MZ**2)*((ee**4*MP**4)/Lambda**2 - (2*ee**4*MP**2*MZ**2)/Lambda**2 + (ee**4*MZ**4)/Lambda**2 + (cw**2*ee**4*MP**4)/(2.*Lambda**2*sw**2) - (cw**2*ee**4*MP**2*MZ**2)/(Lambda**2*sw**2) + (cw**2*ee**4*MZ**4)/(2.*Lambda**2*sw**2) + (ee**4*MP**4*sw**2)/(2.*cw**2*Lambda**2) - (ee**4*MP**2*MZ**2*sw**2)/(cw**2*Lambda**2) + (ee**4*MZ**4*sw**2)/(2.*cw**2*Lambda**2)))/(48.*cmath.pi*abs(MZ)**3)',
