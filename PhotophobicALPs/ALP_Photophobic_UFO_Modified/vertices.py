...
V_35 = Vertex(name = 'V_35',
              particles = [ P.a, P.Z, P.p1 ],
              color = [ '1' ],
              lorentz = [ L.VVS1 ],
              couplings = {(0,0):C.GC_45})

V_36 = Vertex(name = 'V_36',
              particles = [ P.Z, P.Z, P.p1 ],
              color = [ '1' ],
              lorentz = [ L.VVS1 ],
              couplings = {(0,0):C.GC_48})

V_37 = Vertex(name = 'V_37',
              particles = [ P.W__minus__, P.W__plus__, P.p1 ],
              color = [ '1' ],
              lorentz = [ L.VVS1 ],
...
V_56 = Vertex(name = 'V_56',
              particles = [ P.a, P.W__minus__, P.W__plus__, P.p1 ],
              color = [ '1' ],
              lorentz = [ L.VVVS1 ],
...
V_68 = Vertex(name = 'V_68',
              particles = [ P.W__minus__, P.W__plus__, P.Z, P.p1 ],
              color = [ '1' ],
              lorentz = [ L.VVVS1 ],
...
V_126 = Vertex(name = 'V_126',
               particles = [ P.e__plus__, P.e__minus__, P.p1 ],
               color = [ '1' ],
               lorentz = [ L.FFS5 ],
