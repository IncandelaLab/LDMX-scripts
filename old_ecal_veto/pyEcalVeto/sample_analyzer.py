...
branches_info['gx']= { #x position of the photon hit on the target SP
    'rtype': float,
    'default':0.5
    }
branches_info['gy']= {
...
'''
branches_info['recoilLayer1x']= {    
    'rtype': float,
    'default': 0.
    }
branches_info['recoilLayer1y']= {    
    'rtype': float,
    'default': 0.
    }
branches_info['recoilLayer1z']= {    
    'rtype': float,
    'default': 0.
    } 
branches_info['recoilLayer1Px']= {    
    'rtype': float,
    'default': 0.
    }
branches_info['recoilLayer1Py']= {    
    'rtype': float,
    'default': 0.
    }
branches_info['recoilLayer1Pz']= {    
    'rtype': float,
    'default': 0.
    } 
'''  
